...
(14, 'Casas Cueva El Mirador de Galera', 'casa', 22, 'Galera, Granada', 3, 958234345, 'galera@correo.es', '', 'El Mirador de Galera dispone de 8 Casas Cueva rehabilitadas según el estilo tradicional, con todas las comodidades de una vivienda moderna.
...
(15, 'El Corral de Serafín', 'casa', 13, 'Niqüelas, Granada', 4, 958245345, 'corral@correo.es', '', 'El Patio del Carbón, de esta casa solo puedo decir que es un sueño hecho realidad, siempre soñé con tener una casa así y al fin lo conseguí. Hecha con mis manos con mucha dedicación y mucho trabajo.
